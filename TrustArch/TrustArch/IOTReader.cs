...
namespace TrustArch
{
    ...
    public class IOTReader : Reader
    {
        ...
        public override void Recv(AdHocForward.Packet pkg)
        {
        ...
        override public void CheckRoutine()
        {
            ...
            if (this.observedPhenomemons.Count > 0)
            {
                ...
                foreach (KeyValuePair<int, List<IOTEventTrustResult>> entity in l)
                {
                    ...
                    {     
                        byte[] buf = new byte[((IOTGlobal)global).BufSize * results.Count];
        ...
        override public void CheckEvents()
        {
